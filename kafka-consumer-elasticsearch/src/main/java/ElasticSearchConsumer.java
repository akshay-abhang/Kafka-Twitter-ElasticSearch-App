...
public class ElasticSearchConsumer {
    ...
    public static RestHighLevelClient createClient(){
        ...
        String hostname = "kafka-course-4748654779.ap-southeast-2.bonsaisearch.net"; // localhost or bonsai url
        String username = "jbhun9wwgf"; // needed only for bonsai
        String password = "1mhd7qoud"; // needed only for bonsai
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(true){
            ...
            logger.info("Recors-->",records.toString());
